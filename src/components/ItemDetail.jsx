...
const ItemDetail = ({estado}) => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={estado.pictureUrl}/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">Picoquio's</h2>
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">{estado.title}</h1>
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl text-gray-900">${estado.price}</span>
